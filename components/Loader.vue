        ...
        <div v-if="showColdStartMessage" class="mt-4 max-w-md text-center">
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-blue-800 font-medium">AI is warming up...</p>
                        <p class="text-blue-600 text-sm mt-1">This may take a few more seconds as we are starting up. Thank you for your patience!</p>
                    </div>
                </div>
            </div>
        </div>
